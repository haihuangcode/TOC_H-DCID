...
from model.main_model_2 import AV_VQVAE_Encoder, AT_VQVAE_Encoder, AV_VQVAE_Decoder, AT_VQVAE_Decoder, AVT_VQVAE_Encoder, AVT_VQVAE_Decoder, AVT_MLVQVAE_Encoder, AVT_MLVQVAE_Decoder
...
def main():
    ...
    if args.dataset_name == 'ave':
        ...
        meta_csv_path = '../../data/DCID2/feature_extractor/feature_extractor/vggsound-avel40k.csv'
        audio_fea_base_path = '../../data/DCID2/vggsound40k/feature/audio/zip'
        video_fea_base_path = '../../data/DCID2/vggsound40k/feature/video/zip'
        train_dataloader = DataLoader(
    ...
    if args.dataset_name == 'vggsound_AVT':
        ...
        CPC_2 = Cross_CPC_AVT(embedding_dim, hidden_dim=256, context_dim=256, num_layers=2)
    else:
    ...
    Video_mi_net_2 = CLUBSample_group(x_dim=embedding_dim, y_dim=video_dim, hidden_size=256)
    Text_mi_net_2 = CLUBSample_group(x_dim=embedding_dim, y_dim=text_output_dim, hidden_size=256)
    Audio_mi_net_2 = CLUBSample_group(x_dim=embedding_dim, y_dim=audio_output_dim, hidden_size=256)
    ...
    if args.dataset_name == 'vggsound_AVT':
        Decoder = AVT_MLVQVAE_Decoder(audio_dim, video_dim, text_lstm_dim*2, audio_output_dim, video_output_dim, text_output_dim)
    else:
    ...
    Text_mi_net.double()
    Audio_mi_net.double()
    Video_mi_net_2.double()
    Text_mi_net_2.double()
    Audio_mi_net_2.double()
    Decoder.double()
    ...
    Video_mi_net_2.to(device)
    Text_mi_net_2.to(device)
    Audio_mi_net_2.to(device)
    Decoder.to(device)
    
    optimizer = torch.optim.Adam(chain(Text_ar_lstm.parameters(), \
                                       Encoder.parameters(), CPC.parameters(),CPC_2.parameters(), Decoder.parameters()), lr=args.lr)
    ...
    optimizer_video_mi_net_2 = torch.optim.Adam(Video_mi_net_2.parameters(), lr=args.mi_lr)
    optimizer_text_mi_net_2 = torch.optim.Adam(Text_mi_net_2.parameters(), lr=args.mi_lr)
    optimizer_audio_mi_net_2 = torch.optim.Adam(Audio_mi_net_2.parameters(), lr=args.mi_lr)
    ...
    for epoch in range(start_epoch+1, args.n_epoch):
        loss, total_step = train_epoch(CPC, CPC_2, Encoder,Text_ar_lstm, Audio_mi_net, Video_mi_net,Text_mi_net, Audio_mi_net_2, Video_mi_net_2, Text_mi_net_2, Decoder, train_dataloader, criterion, criterion_event,
                                       optimizer, optimizer_audio_mi_net, optimizer_video_mi_net, optimizer_text_mi_net, optimizer_audio_mi_net_2, optimizer_video_mi_net_2, optimizer_text_mi_net_2, epoch, total_step, args)
        #00-RQ-AVT-Noshared-Nocmcm-400-deep4
        save_path = os.path.join(args.model_save_path, 'NoCode-warmstart3-MLVQ-AVT-deep2-model-{}.pt'.format(epoch))#5extra-00-RQ-AVT-Noshared-Nocmcm-3club-400-deep4
        ...
        save_models(Encoder, Text_ar_lstm, epoch, save_path)
...
def save_models(Encoder,Text_ar_lstm, epoch_num, path):
    state_dict = {
        'Encoder_parameters': Encoder.state_dict(),
        'Text_ar_lstm_parameters': Text_ar_lstm.state_dict(),
        'epoch': epoch_num,
...
def train_epoch(CPC, CPC_2, Encoder,Text_ar_lstm, Audio_mi_net, Video_mi_net,Text_mi_net, Audio_mi_net_2, Video_mi_net_2, Text_mi_net_2, Decoder, train_dataloader, criterion, criterion_event,
                                       optimizer, optimizer_audio_mi_net, optimizer_video_mi_net, optimizer_text_mi_net, optimizer_audio_mi_net_2, optimizer_video_mi_net_2, optimizer_text_mi_net_2, epoch, total_step, args):
    ...
    end_time = time.time()
    models = [CPC,CPC_2,Encoder,Text_ar_lstm, Audio_mi_net, Video_mi_net, Text_mi_net,Audio_mi_net_2, Video_mi_net_2, Text_mi_net_2, Decoder]
    to_train(models)
    ...
    for n_iter, batch_data in enumerate(train_dataloader):
        ...
        for i in range(mi_iters):
            ...
            optimizer_audio_mi_net_2, lld_audio_loss_2, optimizer_video_mi_net_2, lld_video_loss_2, optimizer_text_mi_net_2, lld_text_loss_2 = \
                mi_first_forward(audio_feature, video_feature, text_feature, Encoder, 
                     Audio_mi_net, Video_mi_net,Text_mi_net, optimizer_audio_mi_net,optimizer_video_mi_net,optimizer_text_mi_net,
                     Audio_mi_net_2, Video_mi_net_2,Text_mi_net_2, optimizer_audio_mi_net_2,optimizer_video_mi_net_2,optimizer_text_mi_net_2, epoch)
        ...
        audio_recon_loss, video_recon_loss, text_recon_loss, cmcm_loss, equal_num, \
        audio_embedding_loss_2, video_embedding_loss_2, text_embedding_loss_2,mi_audio_loss_2, mi_video_loss_2, mi_text_loss_2, \
        accuracy1_2, accuracy2_2, accuracy3_2, accuracy4_2, accuracy5_2, accuracy6_2, accuracy7_2, accuracy8_2, accuracy9_2, cpc_loss_2, \
        audio_recon_loss_2, video_recon_loss_2, text_recon_loss_2, cmcm_loss_2, equal_num_2,\
        = mi_second_forward(CPC,CPC_2,audio_feature, video_feature, text_feature, Encoder,Audio_mi_net, Video_mi_net, Text_mi_net,Audio_mi_net_2, Video_mi_net_2, Text_mi_net_2, Decoder,epoch)

        if n_iter % 20 == 0:
            logger.info("equal_num is {} equal_num_2 is {} in {}-th iteration.".format(equal_num, equal_num_2, n_iter))
        ...
        loss_items = {
            ...
            "audio_recon_loss_2": audio_recon_loss_2.item(),
            "lld_audio_loss_2": lld_audio_loss_2.item(),
            "audio_embed_loss_2": audio_embedding_loss_2.item(),
            "audio_mine_loss_2": mi_audio_loss_2.item(),
            "text_recon_loss_2": text_recon_loss_2.item(),
            "lld_text_loss_2": lld_text_loss_2.item(),
            "text_embed_loss_2": text_embedding_loss_2.item(),
            "text_mine_loss_2": mi_text_loss_2.item(),
            "video_recon_loss_2": video_recon_loss_2.item(),
            "lld_video_loss_2": lld_video_loss_2.item(),
            "video_embed_loss_2": video_embedding_loss_2.item(),
            "video_mine_loss_2": mi_video_loss_2.item(),
            "cpc_loss_2": cpc_loss_2.item(),
            "cmcm_loss_2": cmcm_loss_2.item(),
        }
        ...
        if epoch<=2:
            ...
            loss = audio_recon_loss + video_recon_loss + text_recon_loss + audio_embedding_loss +  video_embedding_loss\
                    + text_embedding_loss+ mi_audio_loss + mi_video_loss + mi_text_loss + cpc_loss + cmcm_loss\
                    + 0.3 * (audio_recon_loss_2 + video_recon_loss_2 + text_recon_loss_2 + audio_embedding_loss_2 +  video_embedding_loss_2\
                    + text_embedding_loss_2 + mi_audio_loss_2 + mi_video_loss_2 + mi_text_loss_2 + cpc_loss_2+ cmcm_loss_2) 
        
        # loss += audio_recon_loss_2 + video_recon_loss_2 + text_recon_loss_2 + audio_embedding_loss_2 +  video_embedding_loss_2\
        #         + text_embedding_loss_2 + mi_audio_loss_2 + mi_video_loss_2 + mi_text_loss_2 + cpc_loss_2+ cmcm_loss_2
...
def mi_first_forward(audio_feature, video_feature, text_feature, Encoder, 
                     Audio_mi_net, Video_mi_net,Text_mi_net, optimizer_audio_mi_net,optimizer_video_mi_net,optimizer_text_mi_net,
                     Audio_mi_net_2, Video_mi_net_2,Text_mi_net_2, optimizer_audio_mi_net_2,optimizer_video_mi_net_2,optimizer_text_mi_net_2, epoch):
    ...
    if epoch>=3:
        optimizer_video_mi_net_2.zero_grad()
        optimizer_text_mi_net_2.zero_grad()
        optimizer_audio_mi_net_2.zero_grad()

    audio_semantic_result, video_semantic_result, text_semantic_result, audio_semantic_result_2, video_semantic_result_2, text_semantic_result_2,\
    ...
    cmcm_loss, equal_num, cmcm_loss_2, equal_num_2 = Encoder(audio_feature, video_feature, text_feature, epoch)
    ...
    video_encoder_result_2 = video_encoder_result_2.detach()
    text_encoder_result_2 = text_encoder_result_2.detach()
    audio_encoder_result_2 = audio_encoder_result_2.detach()
    ...
    video_vq_2 = video_vq_2.detach()
    text_vq_2 = text_vq_2.detach()
    audio_vq_2 = audio_vq_2.detach()
    ...
    if epoch>=3:
        lld_video_loss_2 = -Video_mi_net_2.loglikeli(video_vq_2, video_encoder_result_2)
        lld_video_loss_2.backward()
        optimizer_video_mi_net_2.step()

        lld_text_loss_2 = -Text_mi_net_2.loglikeli(text_vq_2, text_encoder_result_2)
        lld_text_loss_2.backward()
        optimizer_text_mi_net_2.step()
        
        lld_audio_loss_2 = -Audio_mi_net_2.loglikeli(audio_vq_2, audio_encoder_result_2)
        lld_audio_loss_2.backward()
        optimizer_audio_mi_net_2.step()
    else:
        lld_audio_loss_2 = torch.zeros(1).cuda()
        lld_video_loss_2 = torch.zeros(1).cuda()
        lld_text_loss_2 = torch.zeros(1).cuda()
...
def mi_second_forward(CPC,CPC_2,audio_feature, video_feature, text_feature, Encoder, Audio_mi_net, Video_mi_net, Text_mi_net, Audio_mi_net_2, Video_mi_net_2, Text_mi_net_2, Decoder,epoch):
    audio_semantic_result, video_semantic_result, text_semantic_result, audio_semantic_result_2, video_semantic_result_2, text_semantic_result_2,\
    audio_encoder_result, video_encoder_result, video_club_feature, text_encoder_result, audio_encoder_result_2, video_encoder_result_2, text_encoder_result_2, \
    audio_vq, video_vq, text_vq, audio_vq_2, video_vq_2, text_vq_2, \
    audio_embedding_loss, video_embedding_loss, text_embedding_loss, audio_embedding_loss_2, video_embedding_loss_2, text_embedding_loss_2,\
    ...
    mi_video_loss_2 = Video_mi_net_2.mi_est(video_vq_2, video_encoder_result_2)
    mi_text_loss_2 = Text_mi_net_2.mi_est(text_vq_2, text_encoder_result_2)
    mi_audio_loss_2 = Audio_mi_net_2.mi_est(audio_vq_2, audio_encoder_result_2)
    ...
    accuracy1_2, accuracy2_2, accuracy3_2, accuracy4_2, \
    accuracy5_2, accuracy6_2, accuracy7_2, accuracy8_2, accuracy9_2, \
    cpc_loss_2 = CPC_2(audio_semantic_result_2, video_semantic_result_2, text_semantic_result_2)
    
    audio_recon_loss, video_recon_loss, text_recon_loss, audio_recon_loss_2, video_recon_loss_2, text_recon_loss_2, \
